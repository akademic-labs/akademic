...
export class CoursesComponent implements OnInit {
  ...
  constructor(private _courseService: CourseService, private _institutionService: InstitutionService,
  ...
  ngOnInit() {
    ...
    this._auth.user$.pipe(take(1))
      .subscribe(user => {
        this.user = user;
        this._institutionService.getInstitutionCourses(user.institution)
          .subscribe(result => {
